...
export function AuroraText({
  ...
  // Update dimensions when font size changes or content changes
  useEffect(() => {
  ...
  return (
    <span
      ref={containerRef}
      className={`relative inline-block align-middle ${className} lg:text-[4rem] md:text-[3rem] text-[1.7rem]`}
      style={{
